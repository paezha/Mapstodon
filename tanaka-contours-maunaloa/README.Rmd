...
In this notebook I create a contour map of shield volcano Mauna Loa in Hawaii. The map uses open data and [Tanaka contours](http://wiki.gis.com/wiki/index.php/Tanaka_contours).
